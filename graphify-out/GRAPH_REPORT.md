...
- **Why does `ModelData` connect `ModelData Species Groups` to `PPRCalculator Core Methods`, `Community 33`, `Community 1`, `Ecopath Defaults & LIM`, `Excel Export & Entry Points`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `PPRCalculator` connect `Community 33` to `PPRCalculator Core Methods`, `Community 1`, `Community 2`, `Ecopath Defaults & LIM`, `Excel Export & Entry Points`, `ModelData Species Groups`, `Community 7`, `SpeciesGroup Model`, `Community 9`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `DataFrame` connect `Community 33` to `PPRCalculator Core Methods`, `Community 1`, `Community 2`, `Ecopath Defaults & LIM`, `Excel Export & Entry Points`, `ModelData Species Groups`, `Community 7`, `SpeciesGroup Model`, `Community 9`?**
