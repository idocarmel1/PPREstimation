...
## Corpus Check
- 257 files · ~3,208,285 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 237 nodes · 409 edges · 31 communities (10 shown, 21 thin omitted)
...
## Knowledge Gaps
- **61 isolated node(s):** `Knowledge Graph`, `Project Overview`, `graphify`, `1. Symptom`, `2. Root cause` (+56 more)
